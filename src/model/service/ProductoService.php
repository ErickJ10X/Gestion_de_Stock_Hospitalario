...
class ProductoService
{
    ...
    public function getAllProductos(): array
    {
        try {
            ...
            throw new PDOException("Error al cargar los productos: " . $e->getMessage());
        }
    }
    ...
    public function getProductoById($id): ?Productos
    {
        try {
            ...
            throw new PDOException("Error al cargar el producto: " . $e->getMessage());
        }
    }
    ...
    public function updateProducto($id, $codigo, $nombre, $descripcion, $unidad_medida): bool
    {
        try {
            ...
            return $this->productoRepository->update($productoActualizado);
        } catch (PDOException $e) {
    ...
    public function createProducto($codigo, $nombre, $descripcion, $unidad_medida): bool
    {
        try {
            ...
            throw new PDOException("Error al crear el producto: " . $e->getMessage());
        }
    }
}
