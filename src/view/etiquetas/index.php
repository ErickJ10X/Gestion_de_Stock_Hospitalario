                                    ...
                                    <td>
                                        <?php if (isset($productosInfo[$etiqueta->getIdProducto()])): ?>
                                            ...
                                            <small class="text-muted">
                                                <?php echo isset($productosInfo[$etiqueta->getIdProducto()]->getReferencia) ? 
                                                    $productosInfo[$etiqueta->getIdProducto()]->getReferencia() : ''; ?>
                                            </small>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-primary" 
                                                    ...
                                                    data-referencia="<?php echo isset($productosInfo[$etiqueta->getIdProducto()]) && isset($productosInfo[$etiqueta->getIdProducto()]->getReferencia) ? $productosInfo[$etiqueta->getIdProducto()]->getReferencia() : ''; ?>"
