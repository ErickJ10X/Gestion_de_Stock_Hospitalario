...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form id="formCrearAlmacen" action="/Pegasus-Medical-Gestion_de_Stock_Hospitalario/src/controller/AlmacenesHandler.php" method="POST" class="card-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tipo_almacen_create" name="tipo" required>
                        <div class="form-text">Ejemplo: General, Medicamentos, Equipos, etc.</div>
                    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div id="editar_almacen_form_container" style="display: none;">
                    <form id="formEditarAlmacen" action="/Pegasus-Medical-Gestion_de_Stock_Hospitalario/src/controller/AlmacenesHandler.php" method="POST" class="card-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tipo_almacen_edit" name="tipo" required>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    foreach ($almacenes as $almacen) {
        ...
        echo "planta_id: " . $almacen->getIdPlanta() . ",";
